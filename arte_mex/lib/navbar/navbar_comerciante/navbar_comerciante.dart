...
class NavbarComerciante extends StatefulWidget {
  final Function currentIndex;
  const NavbarComerciante({super.key, required this.currentIndex});

  @override
  State<NavbarComerciante> createState() => _NavbarComercianteState();
}
      ...
      items: <BottomNavigationBarItem>[
        BottomNavigationBarItem(
            icon: SvgPicture.asset(
              'assets/imagenes_iconos_navbar/verificacion.svg',
              color: (index == 0)
